...
int main() {
  // Part 1
	//creates a window, starts up an OpenGL context, and initializes graphical entities
  init();
...
static void init() {
  // Part 1
	//creating a window and starting the OpenGL context
  if (!GLHelper::init(2400, 1350, "Tutorial 2 | ")) { //GLHelper::init(): Start OpenGL context
